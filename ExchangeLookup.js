...
function exchange (market){
	...
	var marketCode = {
		...
		NFX: {name:'Nasdaq Futures (Cleared by OCC)', website:'http://business.nasdaq.com/nasdaq-futures/nfx-market', email:'memberservices@theocc.com', holiday:'http://www.nasdaqomx.com/searchresult?q=holiday+NFX'},
		...
		CCE: {name:'Chicago Climate Exchange (ICE)', website:'https://www.theice.com/ccx', email:'', holiday:'https://www.theice.com/holiday-hours'},
		MX: {name:'Montreal Exchange (TMX)', website:'https://www.m-x.ca/accueil_en.php', email:'', holiday:'https://www.m-x.ca/qui_jours_en.php'},
