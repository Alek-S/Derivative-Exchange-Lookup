...
function exchange (market){
	...
	var marketCode = {
		...
		NFX: {name:'NASDAQ OMX Futures Exchange (Cleared by OCC, prevously PBOT)', website:'http://business.nasdaq.com/nasdaq-futures/nfx-market', email:'memberservices@theocc.com', holiday:'http://www.nasdaqomx.com/searchresult?q=holiday+NFX'},
		...
		OMX: {name:'NASDAQ OMX Futures Exchange (Cleared by OCC, prevously PBOT)', website:'http://business.nasdaq.com/nasdaq-futures/nfx-market', email:'memberservices@theocc.com', holiday:'http://www.nasdaqomx.com/searchresult?q=holiday+NFX'},
		...
		ZCE: {name: 'Zhengzhou Commodity Exchange', website:'http://english.czce.com.cn/', email:'', holiday:''},
<<<<<<< HEAD
		SAFEX: {name: 'Johannesburg Stock Exchange ( Formerly South African Futures Exchange)', website:'https://www.jse.co.za/redirects/safex', email:'info@jse.co.za', holiday:''},
		JSE: {name: 'Johannesburg Stock Exchange ( Formerly South African Futures Exchange)', website:'https://www.jse.co.za/redirects/safex', email:'info@jse.co.za', holiday:''},
=======
		SAFEX: {name: 'South African Futures Exchange', website:'www.safex.co.za', email:'', holiday:''},
>>>>>>> 0e2e8869257ac823dc3ae1b0f224fa9c9eef3d2a
